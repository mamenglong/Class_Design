...
public class RegisterActivity extends BaseActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyApplication.getApplication().setRegisterActivity(this);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            try {
                ...
                if(!LitePal.isExist(User.class,"userName= ?",mEmail)){
                    Retrofit retrofit = new Retrofit.Builder()
                            .addConverterFactory(GsonConverterFactory.create())
                            .baseUrl(getResources().getString(R.string.baseURL))
                            .build();
                    UserResult.InsertInterface request=retrofit.create(UserResult.InsertInterface.class);
                    ...
                    if(response.isSuccessful()&&response.body().isResult())
                    {
                        ...
                        result=2;
                        LogUtils.i(response.errorBody().toString());
                    }
        ...
        protected void onPostExecute(final Integer success) {
            ...
            switch (success){
                case 1:
                    ...
                    break;
                case 2:
                    Toast.makeText(RegisterActivity.this,"网络端插入失败！",Toast.LENGTH_SHORT).show();
                    break;
                case 3:
                    ...
                    break;
                case 4:
                    Toast.makeText(RegisterActivity.this,"插入异常！",Toast.LENGTH_SHORT).show();
                    break;
            }
