...
//Context.MODE_WORLD_WRITEABLE 表示当前文件可以被其他应用写入
    ...
    private SPUtils(final String spName) {
        sp = MyApplication.getApplication().getLoginActivity().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = MyApplication.getApplication().getLoginActivity().getSharedPreferences(spName, mode);
    }
